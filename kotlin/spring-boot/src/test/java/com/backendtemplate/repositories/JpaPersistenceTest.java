...
class JpaPersistenceTest {
    ...
    void orderedBatchPreservesForeignKeysAndRollsBackFailedResult() throws Exception {
        ...
        try (var app = new SpringApplicationBuilder(TemplateApplication.class)
            ...
            assertThat(service.replay("batch", "first").getReservation()).isEqualTo(first.getReservation());
    ...
    static class Work {
        ...
        public void decreaseWithManagedProduct() {
            ...
            var before = products.findById("fresh");
            ...
            var after = products.findById("fresh");
            assertThat(after).isNotNull();
            assertThat(after).isNotSameAs(before);
            assertThat(after.availableStock()).isEqualTo(1);
            entities.flush();
        }
